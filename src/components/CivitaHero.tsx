...
const description = [
  "This watercolor drawing captures Civita as a quiet hilltop town shaped by stone, landscape, and time. The soft colors show the fragile beauty of the place, while the loose lines suggest its old walls, narrow streets, and dramatic connection to the surrounding valley.",
  "Through watercolor, I wanted to show Civita not only as a historic town, but as a place that feels suspended between nature and architecture. The drawing reflects its silence, texture, and sense of memory.",
];

export function CivitaHero() {
      ...
      <div className="relative flex-1 grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-10 items-center px-6 md:px-12 pt-10 md:pt-16 pb-12">
        ...
        >
          ...
          <motion.h2
            ...
            className="font-display italic text-[clamp(2.75rem,7vw,5.75rem)] leading-[0.92] tracking-[-0.03em] mt-4"
          >
            <span className="not-italic">Civita.</span>
          </motion.h2>
        ...
        >
          ...
          >
            <ZoomableImage
              ...
              alt="Civita — watercolor study of a hilltop town"
