    ...
    <div className="relative bg-[#0a0a0a] text-[#f2f2f0] font-sans overflow-x-hidden">
      ...
      <section className="relative min-h-[100svh] grid grid-cols-1 md:grid-cols-2 gap-0">
        ...
        <div className="relative flex flex-col justify-center px-8 md:px-16 py-20 md:py-0">
          <motion.p
            {...fadeUp(0.2)}
            className="text-[11px] uppercase tracking-[0.28em] text-[#c8c8bf] mb-6"
          >
            Endale
          </motion.p>
          ...
          <motion.h1
            {...fadeUp(0.35)}
            className="font-serif text-[clamp(4.5rem,14vw,14rem)] leading-[0.88] tracking-[-0.03em]"
          >
            <span className="italic font-light">Bekele</span>
          </motion.h1>

          <motion.p
            {...fadeUp(0.55)}
            className="mt-6 md:mt-8 text-[10px] md:text-[11px] uppercase tracking-[0.32em] text-[#c8c8bf]"
          >
